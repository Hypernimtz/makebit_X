/*
Hunan Makerobo Intelligent Technology Co., Ltd.
Editor: Zhu Lin
...
namespace makerobo {
    ...
    */
    ...
    //% blockId=robotbit_stop block="Stop Motor|%index|"
    //% weight=80
    export function MotorStop(index: Motors): void {
        MotorRun(index, 0);
    }

    //% blockId=robotbit_stop_all block="Stop All Motors"
    //% weight=79
    //% blockGap=50
    ...
    //% blockId=Microbit_Sensor_IR block="IR Obstacle Sensor|Pin %pin|Value %value"
    //% weight=96
    //% blockGap=20
    //% color="#228B22"
    ...
    //% blockId=Microbit_Sensor_flame block="Flame Sensor|Pin %pin|Value %value"
    //% weight=97
    //% blockGap=20
    //% color="#228B22"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
    ...
    //% blockId=Microbit_ping block="Ultrasonic Module|echo %echo|unit %unit"
